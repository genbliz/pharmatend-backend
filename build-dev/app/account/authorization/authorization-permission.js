...
export const DefinedUserPermission = {
    order: {
        view: {
            name: "order.view",
...
export function getAllAuthorizationPermissionParameters() {
    ...
    const permissionItemObj = {};
    const permissionFlattenedObj = {};
...
//# sourceMappingURL=authorization-permission.js.map