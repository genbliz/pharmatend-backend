import Joi from "joi";
import { JoiStringDefaultOrStrip, JoiDateFormat_YYYY_MM_DD, JoiStripWhenNull } from "@/core/base-joi-helper";
import { BaseTenantModelFunc } from "@/core/base-schema-model";
import { IProduct, ProductCategoryEnum } from "./product-types";
